...
import { FaUsers, FaChurch } from "react-icons/fa6";
...
interface GroupRetreatsGridProps {
    initialPackages: Package[];
}

export default function GroupRetreatsGrid({ initialPackages }: GroupRetreatsGridProps) {
        ...
        <>
            ...
            <div className={styles.searchSection}>
                <div className={styles.searchWrapper}>
                    ...
                    <input
                        type="text"
                        placeholder="Search group retreat packages..."
                ...
                <div className={styles.filterWrapper}>
                    ...
                    <div className={styles.filterTabs}>
                        ...
                        <button
                            className={`${styles.filterTab} ${activeFilter === 'Corporate' ? styles.active : ''}`}
                            onClick={() => setActiveFilter('Corporate')}
                        >
                            <FaUsers size={14} /> Corporate
                        </button>
                        <button
                            className={`${styles.filterTab} ${activeFilter === 'Church' ? styles.active : ''}`}
                            onClick={() => setActiveFilter('Church')}
                        >
                            <FaChurch size={14} /> Church
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div className={styles.grid}>
                    ...
                    return (
                        <div key={pkg.id} className={styles.card}>
                            <div className={styles.imageWrapper}>
                                <span className={styles.tag}>Group Retreat</span>
                                <Image
                ...
                {filteredPackages.length === 0 && (
                    <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '60px', color: '#666' }}>
                        <p>No group retreat packages found matching your search.</p>
                    </div>
                )}
            </div>
        </>
