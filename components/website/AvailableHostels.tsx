...
import styles from './AvailableHostels.module.css';
...
const AvailableHostels = async () => {
    // Fetch ALL hostels from database with amenities
    ...
    // Randomly shuffle and pick 3 unique hostels
    const hostels = shuffleArray(allHostels).slice(0, 3);

    return (
        <section className={styles.section}>
            <div className={styles.header}>
                <h2 className={styles.mainTitle}>Available Lodges</h2>
                <p className={styles.subTitle}>Comfortable and affordable lodging designed for professionals, leaders, and retreat guests seeking a peaceful and relaxing stay.</p>
            </div>
            <div className={styles.grid}>
                {hostels.map((hostel) => {
                    // Map DB amenities to string array for display
                    const displayAmenities = hostel.amenities.map(a => a.amenityName);
            ...
            <div className={styles.viewMoreContainer}>
                <Link href="/services/hostels">
                    <button className={styles.viewMoreButton}>
                        View All Lodges <FaArrowRight size={14} />
                    </button>
                </Link>
            </div>
        </section>
