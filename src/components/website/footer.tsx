        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center gap-0 mb-6">
              ...
              />
              <span className="text-xl font-black tracking-tight uppercase -ml-3">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold mb-8 relative after:content-[''] after:absolute after:left-0 after:-bottom-2 after:w-8 after:h-1 after:bg-[#eea000]">Quick Links</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="text-lg font-bold mb-8 relative after:content-[''] after:absolute after:left-0 after:-bottom-2 after:w-8 after:h-1 after:bg-[#eea000]">Our Products</h4>
            <ul className="space-y-4 text-sm text-gray-400">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-bold mb-8 relative after:content-[''] after:absolute after:left-0 after:-bottom-2 after:w-8 after:h-1 after:bg-[#eea000]">Get In Touch</h4>
            <ul className="space-y-4 text-sm text-gray-400">
