  ...
  return (
    <section className="relative py-24 overflow-hidden bg-[#2d2d2d]">
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-7xl">
        ...
        {/* Top Section */}
        <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-8 md:gap-24 mb-[-60px] relative z-20">
          
          {/* Vertical Image (Shea Butter) */}
          <div className="w-[300px] md:w-[380px] aspect-[3/4.5] relative shadow-2xl border-[12px] border-[#2d2d2d] md:ml-12">
            <Image 
              src="/butter_1.jpg" 
              alt="Premium Shea Butter" 
              fill
          ...
          {/* About Us Content */}
          <div className="text-center md:text-left relative pt-0 pb-12 flex-1 flex flex-col justify-start md:mt-[-20px] px-4 md:px-0 max-w-3xl mx-auto md:mx-0">
            <p className="text-[#eea000] font-bold tracking-[0.2em] text-[15px] uppercase mb-6 text-center md:text-left">About Us</p>
            <div className="space-y-6 text-gray-300 text-[18px] leading-relaxed text-left">
              <p>
                <strong className="text-white text-[20px] block mb-2">Manono Manphis is a trusted export company based in Ghana,</strong> 
        ...
        {/* Bottom Section */}
        <div className="flex flex-col md:flex-row bg-white shadow-2xl overflow-hidden relative z-10 mx-auto max-w-7xl">
          {/* Left Content (White) */}
          <div className="flex-[1.5] p-14 flex flex-col justify-center items-center text-center bg-white relative min-w-[350px] min-h-[480px]">
            <h3 className="text-2xl md:text-3xl font-black text-[#1a1a1a] leading-tight mb-4" style={{fontFamily: "'Plus Jakarta Sans', sans-serif"}}>
              Reliable <br />
              Bulk Export <br />
              <span className="text-[#eea000]">from Ghana</span>
            </h3>
            
            <p className="text-gray-500 text-[14px] leading-relaxed mb-8 max-w-[280px] mx-auto">
          ...
          {/* Right Image */}
          <div className="flex-[2.5] relative min-h-[480px]">
            <Image 
