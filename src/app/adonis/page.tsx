  ...
  const downloadImage = async () => {
    if (cardRef.current) {
      try {
        ...
        link.href = dataUrl;
        link.download = 'Adonis_Business_Card.jpg';
    ...
    >
      ...
      <div ref={cardRef} className="relative flex flex-row w-full max-w-[550px] bg-white p-6 sm:p-10 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.06)] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-10 pointer-events-none z-0">
          <img src="/billboards/White_Logo.png" alt="" className="w-64 h-64 object-contain scale-125" />
        </div>
        ...
        <div className="flex-1 z-10">
          {/* Header Section */}
          <div className="mb-6">
            <h1 className={`text-[22px] sm:text-[32px] whitespace-nowrap font-black tracking-wide text-[#09355c] ${playfair.className}`} style={{ textShadow: '0.5px 0.5px 0px rgba(0,0,0,0.1)' }}>
              ADONIS L. MACAULEY
            </h1>
        ...
        <div className="shrink-0 ml-4 flex items-end justify-end z-10">
          <div className="p-1.5 border-[1.5px] border-gray-100 rounded-lg bg-white shadow-sm transition-transform hover:scale-105 cursor-pointer">
            <img 
              src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&color=095b9e&data=VCARD:N:Macauley;Adonis;L.;;%0AORG:Whitecap%20International%20Limited%0ATITLE:Chief%20Executive%20Officer%0ATEL:+23275126123%0AEMAIL:adonismacauley@gmail.com%0AADR:;;50%20Siaka%20Stevens%20Street;Freetown;;;%0A" 
      ...
      <button 
        ...
        className="absolute bottom-6 sm:bottom-10 bg-[#095b9e] hover:bg-[#07477a] text-white px-6 py-2.5 rounded-full font-semibold shadow-[0_4px_14px_rgba(9,91,158,0.39)] transition-all flex items-center gap-2 text-sm sm:text-base z-20"
      >
