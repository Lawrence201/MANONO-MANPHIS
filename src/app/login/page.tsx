        ...
        <div className="flex-1 flex flex-col items-center justify-center p-4 max-[480px]:mt-0 mt-16 sm:mt-0 w-full">
          <div className="w-full max-w-[360px] space-y-4 max-[480px]:space-y-3.5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button type="button" onClick={() => signIn("google", { callbackUrl: searchParams?.get("callbackUrl") || "/" })} className="relative flex items-center justify-center gap-2 py-2 px-4 rounded-md bg-transparent border border-white/10 hover:bg-white/5 transition-colors text-[13px] font-medium text-white group">
