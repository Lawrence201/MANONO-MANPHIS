...
export default function LogosTemplate2() {
  ...
  useEffect(() => {
    ...
    setQrUrl(`https://api.qrserver.com/v1/create-qr-code/?size=150x150&color=095b9e&data=${encodeURIComponent(window.location.origin + '/abie')}`);
    
    // Update document title for printing
    document.title = "Logos Template 2";
