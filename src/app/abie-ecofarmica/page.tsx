...
export default function AbieEcofarmicaCard() {
  ...
  const downloadImage = async () => {
    if (cardRef.current) {
      try {
        ...
        link.href = dataUrl;
        link.download = 'Abie_Ecofarmica_Card.jpg';
      ...
      <div ref={cardRef} className="relative flex flex-row w-full max-w-[550px] bg-white p-6 sm:p-10 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.06)] overflow-hidden">
        ...
        <div className="shrink-0 ml-4 flex items-end justify-end z-10">
          <div className="p-1.5 border-[1.5px] border-gray-100 rounded-lg bg-white shadow-sm transition-transform hover:scale-105 cursor-pointer">
            <img 
              src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&color=137A20&data=VCARD:N:Macauley;Abie;;;%0AORG:Ecofarmica%0ATITLE:General%20Manager%0ATEL:+23231837455%0AEMAIL:abie1170@yahoo.com%0AADR:;;50%20Siaka%20Stevens%20Street;Freetown;;;%0A" 
