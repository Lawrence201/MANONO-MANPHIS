...
export default function LogosTemplate4() {
  ...
  useEffect(() => {
    ...
    setQrUrl(`https://api.qrserver.com/v1/create-qr-code/?size=150x150&color=137A20&data=${encodeURIComponent(window.location.origin + '/abie-ecofarmica')}`);
    
    // Update document title for printing
    document.title = "Logos Template 4";
