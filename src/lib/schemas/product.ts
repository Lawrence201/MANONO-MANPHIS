...
export const ProductSchema = z.object({
  ...
  cashewGrade: z.union([z.string(), z.null()]).transform(v => (v === "" || v === undefined) ? null : v).nullish(),
  ...
  sheaGrade: z.union([z.string(), z.null()]).transform(v => (v === "" || v === undefined) ? null : v).nullish(),
